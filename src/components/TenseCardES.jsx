...
/* ============================================================
   TenseCardES — one Spanish tense's reference card (shared)
   ------------------------------------------------------------
   Used by:
     • TenseExplainerES.jsx — accordion mode (with onPractise)
     • TenseTaggerES.jsx    — "📖 See the full card" overlay
   Extracted verbatim from TenseExplainerES.jsx so the Tagger's
...
export default function TenseCardES({ tense, onPractise }) {
