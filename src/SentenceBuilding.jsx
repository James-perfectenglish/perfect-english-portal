...
const LEVELS = [
  {
    ...
    label: 'Beginner',
    sublabel: 'A1 – A2',
    badgeLabel: 'Level: A2 Elementary',
    description: 'Simple sentences with common vocabulary and basic grammar structures.',
    colour: '#48bb78',
    colourLight: '#f0fff4',
    dbLevels: ['A1', 'A2'],
    icon: '🌱'
  },
  {
    ...
    description: 'Longer sentences with phrasal verbs, conditionals, and more complex structures.',
    colour: '#4299e1',
    colourLight: '#ebf8ff',
    dbLevels: ['B1', 'B2'],
    icon: '📘'
  },
  {
    ...
    label: 'Advanced',
    sublabel: 'C1 – C2',
    badgeLabel: 'Level: C1-C2 Advanced',
    description: 'Complex sentences with advanced grammar, idioms, and nuanced word order.',
    colour: '#ed8936',
    colourLight: '#fffaf0',
    dbLevels: ['C1', 'C2'],
    icon: '🎓'
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <p style={{ margin: '8px 0 0', opacity: 0.9 }}>
            Build correct sentences by putting words in the right order
          </p>
        </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            margin: '0 0 24px',
            textAlign: 'center'
          }}>Select a difficulty to start practising</p>
