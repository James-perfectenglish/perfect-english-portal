 ...
 const saveResult = async (finalScore) => {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      {/* Header */}
      <div style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '12px 12px 0 0', padding: '2rem', textAlign: 'center', color: 'white' }}>
        <button onClick={onBack} style={{ background: 'none', border: '1px solid white', color: 'white', padding: '6px 14px', borderRadius: '6px', cursor: 'pointer', position: 'absolute', left: '20px', fontSize: '0.9rem' }}>← Back</button>
